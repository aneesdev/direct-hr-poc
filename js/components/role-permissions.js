...
const RolePermissionsComponent = {
    ...
    setup() {
        ...
        const rolePermissions = ref({
            ...
            2: ['home', 'employee_directory', 'my_profile', 'payroll', 'new_request', 'requests_tracker', 'new_hd_request', 'request_hd_tracker', 'payroll_in_stats'],
            3: ['home', 'employee_directory', 'my_profile', 'new_request', 'requests_tracker', 'new_hd_request', 'request_hd_tracker', 'training_paths', 'training_assign', 'training_tracking'],
            4: ['home', 'employee_directory', 'my_profile', 'payroll', 'shift_scheduling', 'weekly_shift_summary', 'attendance', 'new_request', 'requests_tracker', 'new_hd_request', 'request_hd_tracker', 'training_paths', 'training_assign', 'training_tracking', 'new_appraisal_cycle', 'appraisals_tracking', 'appraisals_results', 'employees', 'company_news', 'directory_documents', 'orders_requests_settings', 'help_desk_requests_settings', 'employee_documents', 'splits_in_profile', 'general_filter_crud'],
            ...
            6: ['home', 'employee_directory', 'my_profile', 'shift_scheduling', 'weekly_shift_summary', 'attendance', 'new_request', 'requests_tracker', 'new_hd_request', 'request_hd_tracker', 'training_paths', 'training_assign', 'training_tracking', 'appraisals_tracking', 'appraisals_results', 'line_manager_crud'],
            7: ['home', 'employee_directory', 'my_profile', 'payroll', 'shift_scheduling', 'weekly_shift_summary', 'attendance', 'new_request', 'requests_tracker', 'new_hd_request', 'request_hd_tracker', 'appraisals_results', 'payroll_in_stats'],
